...
export const RC_API_KEY   = 'test_lNqmlblIbtArehvcvGZJSjfGBXY';
export const ENTITLEMENT  = "Chalky's Crew";
...
/** Returns true if the user has an active "Chalky's Crew" entitlement. */
